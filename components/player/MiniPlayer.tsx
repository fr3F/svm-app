...
function makeStyles(c: ThemeColors) {
  return StyleSheet.create({
    ...
    viewport: { flex: 1, width: "100%", overflow: "hidden", alignItems: "center" },
    track: { alignItems: "center" },
    char: { fontSize: rf(10), fontWeight: "700", color: c.text, lineHeight: CHAR_H, textAlign: "center" },
    iconBox: {
      width: rs(22), height: rs(22), borderRadius: rs(7),
...
export default function MiniPlayer() {
  ...
  return (
    <TouchableOpacity
      ...
      activeOpacity={0.85}
    >
      <Ionicons name="musical-notes" size={rs(13)} color={c.accent} />
      ...
      <View style={styles.iconBox}>
        <Ionicons name="headset" size={rs(13)} color={c.accentText} />
      </View>
    </TouchableOpacity>
  );
}
